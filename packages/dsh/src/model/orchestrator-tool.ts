...
export const ORCHESTRATOR_TOOL_SURFACE = {
  ...
  parameters: {
    ...
    script: { type: 'string', required: true, description: 'Control script; it runs from the same workspace b2f populated, ws is on PATH, WS_ROOT_SURFACE names the authorized root, WS_WORKING_SURFACE, WS_WORKING_PATH, and WS_BASE_REVISION identify the prepared session checkout, and ws help init supplies authoring guidance.' },
